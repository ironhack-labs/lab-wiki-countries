...
const CountriesDatails = (props) => {
    const foundCountry = countries.find(elm => props.match.params.cca3 === elm.cca3)
    return (
        <div className="col-7">
            <h1>{foundCountry.name.common} {foundCountry.flag}</h1>
            <table className="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><strong>{foundCountry.capital}</strong></td>
                    </tr>
                    <tr>
                        <td>
                            <h3>Area</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                {foundCountry.borders.map((elm, idx) => <li key={idx}><Link key={idx} to={elm}> {countries.find((country) => country.cca3 === elm).name.common}</Link> </li>)}
                            </ul>
                        </td>
                    </tr>
                </tbody>
...
export default CountriesDatails;
