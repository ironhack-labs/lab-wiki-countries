...
class CountryDetail extends Component {
  ...
  render() {
    ...
    let countryBorders = this.props.countries.filter(b => country[0].countryBorders.includes(b.cca3))
   ...
   return(
    <div>
     ...
     <li><Link to={"/"+e.cca3} className="list-group-item list-group-item-action" key={e.cca3}>{e.name.official}</Link></li>)
     }
      </ul>
