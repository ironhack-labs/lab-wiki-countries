...
function CountryDetails({ countries }) {
  ...
  const borderLinks = borders => borders.map((borderItem, index) => {
      ...
      {foundCountry && (
        <>
          ...
          <table className="table">
            <tbody>
              <tr>
                <td style={{width: 30 + '%'}}><b>Capital</b></td>
                <td>
                  {foundCountry.capital}
                </td>
              </tr>
              <tr>
                <td style={{width: 30 + '%'}}><b>Area</b></td>
                <td>
                  {foundCountry.area}<sup>2</sup>
                </td>
              </tr>
              <tr>
                <td className="name-top" style={{width: 30 + '%'}}><b>Borders</b></td>
                <td>
                  <ul>
