  ...
  return (
    <div>
      {countries
        ...
        .map(country =>
          <div className="card w-100 d-flex justify-content-center cardetail" key={country.alpha3Code}>
            <p className="text-center">
              <img src={`https://flagpedia.net/data/flags/icon/72x54/${country.alpha2Code.toLowerCase()}.png`} className="card-img-top" alt="countryPicture" style={{ width: 200}}/>
            </p>
