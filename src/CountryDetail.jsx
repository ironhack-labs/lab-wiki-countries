...
export default class CountryDetail extends Component {
  ...
  render() {
    let myCountry = countries.find(country => country.cca3 === this.props.match.params.id)
    return (
      ...
      <div className="col-7 text-justify padd">
        ...
        <table className="table">
          ...
          <tr>
            <td>Area:</td>
            <td>{myCountry.area} km<sup>2</sup></td>
          </tr>
          <tr>
            <td>Borders:</td>
            <td>
            <ul>
              {myCountry.borders.map((border, i) => {
                ...
                return <li>
                  <Link to={`/country/${neighbor.cca3}`}>{neighbor.name.common}</Link>
                </li>
              })}
            </ul>
            </td>
